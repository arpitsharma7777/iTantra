            ...
            when (pendingPermissionAction) {
                PendingPermissionAction.DISCOVER -> {
                    if (isLocationEnabled(context)) {
                        actualViewModel.startDiscovery()
                    } else {
    ...
    NavHost(
        ...
        composable(Screen.Home.route) {
            HomeScreen(
                ...
                onClearError = actualViewModel::clearError
            )
        }
        composable(Screen.Connection.route) {
            ConnectionScreen(
                ...
                onDisconnectClicked = actualViewModel::disconnect,
        ...
        composable(Screen.Communication.route) {
            CommunicationScreen(
                uiState = uiState,
                onLanguageSelected = actualViewModel::updateSelectedLanguage,
                onMicPressed = {
                ...
                onMicReleased = actualViewModel::stopSpeaking,
                onClearError = actualViewModel::clearError,
                onBack = { navController.popBackStack() }
            )
        }
        composable(Screen.Settings.route) {
            SettingsScreen(
                uiState = uiState,
                onUpdateLanguage = actualViewModel::updateSelectedLanguage,
                onBack = { navController.popBackStack() },
